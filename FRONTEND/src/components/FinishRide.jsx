...
const FinishRide = (props) => {
  return (
    <div>
    <h5 className='p-3 text-center absolute top-3 right-3 font-bold text-2xl' onClick={()=>props.setFinishPanel(false)}><i className='ri-arrow-down-wide-line text-gray-600'></i></h5>
      <h2 className='font-semibold text-2xl mb-5'>Finish This Ride</h2>
      ...
      <div className='flex gap-2 items-center justify-center flex-col'>
          ...
          <div className='w-full'>
            <Link to={'/captain-home'} className='bg-green-600 flex justify-center text-white font-semibold py-2 px-4 mt-7 rounded w-full'>Finish Ride</Link>
            <p className='text-xs text-red-600 p-2'>Click on finish Ride button if You have completed the payment</p>
          </div>
