  ...
  return (
    <div>
       <div className='flex items-center justify-between mb-4 '>
        ...
        <div className='flex items-start justify-center gap-4 p-3 bg-gray-100 rounded-xl'>
          <div className='text-center'>
            <i className='text-lg font-medium ri-timer-2-line'></i>
            <h5 className='font-medium text-lg'>10.2</h5>
            <p className='text-sm text-gray-600'>Hours Online</p>
          </div>
          <div className='text-center'>
            <i className='text-lg font-medium ri-speed-up-line'></i>
            <h5 className='font-medium text-lg'>10.2</h5>
            <p className='text-sm text-gray-600'>Hours Online</p>
          </div>
          <div className='text-center'>
            <i className='text-lg font-medium ri-booklet-line'></i>
            <h5 className='font-medium text-lg'>10.2</h5>
            <p className='text-sm text-gray-600'>Hours Online</p>
          </div>
        </div>
