...
const RidePopUp = (props) => {
  return (
    <div>
      <h5 className='p-3 text-center absolute top-3 right-3 font-bold text-2xl' onClick={()=>props.setRidePopUp(false)}><i className='ri-arrow-down-wide-line text-gray-600'></i></h5>
        <h2 className='font-semibold text-2xl mb-5'>Ride for You!</h2>
        ...
        <div className='flex gap-2 items-center justify-center flex-col'>
            ...
            } className='bg-green-600 text-white font-semibold py-2 px-4 mt-7 rounded w-full'>Accept</button>

            <button onClick={()=>{props.setRidePopUp(false)
            }
            } className='bg-gray-300 text-black font-semibold py-2 px-4 mt-2 rounded w-full'>Ignore</button>
        </div>
    </div>
  )
}
