    ...
    <div>
      <h5 className='p-3 text-center absolute top-3 right-3 font-bold text-2xl' onClick={()=>props.setVehiclePanelOpen(false)}><i className='ri-arrow-down-wide-line text-gray-600'></i></h5>
        <h2 className='font-semibold text-2xl mb-5'>Choose a vehicle</h2>
          ...
          <div onClick={()=>props.setConfirmedRidePanel(true)} className='flex border-2 active:border-gray-600 rounded-xl items-center justify-between w-full p-3 mb-2'>
          ...
          <div onClick={()=>props.setConfirmedRidePanel(true)} className='flex border-2 active:border-gray-600 rounded-xl items-center  justify-between w-full p-3'>
